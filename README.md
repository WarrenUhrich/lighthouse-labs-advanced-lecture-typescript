...
git clone git@github.com:WarrenUhrich/lighthouse-labs-advanced-lecture-typescript.git

# Switch to this branch
git checkout 2024.04.11-web-flex-day-16october2023

# Install dependencies
npm install

# Run TypeScript compiler to populate ./build directory
npx tsc --project ./tsconfig.json
```

With these steps completed, you can run the TypeScript example files. Note that some have warnings and errors on-purpose to demonstrate TS' stronger typing and rules.

* `node build/01-hello.js`
* `node build/02-function-example.js`
* `node build/03-example.js`
* `node build/04-implicit-typing.js`
* `node build/05-explicit-typing.js`
* `node build/06-arrays.js`
* `node build/07-multiple-types.js`
* `node build/08-object-shapes.js`
* `node build/09-functions.js`
* `node build/10-generics.js`

To run the React example, continue from the previous steps and carry out the following:
